...
public class accelerometerToFrequencySimple implements HBAction {
    @Override
        ...
        new AccelerometerListener(hb) {
            ...
            public void sensorUpdated(float x_val, float y_val, float z_val) { // Write your code below this line
                ...
                hb.setStatus("in: " + String.format("%.1g", x_val) +
                        ...
                        ", out: " + String.format("%.1g", (x_val - x_val_MIN) / x_RANGE * out_RANGE )
                );

                float out = (x_val - x_val_MIN) / x_RANGE * out_RANGE;
